    ...
    return (
        <section className='w-fit flex flex-col gap-2'>
            ...
            <div>
                ...
                <div>
                    <Input disabled={isDoing} placeholder='New Product Name' className='h-10' value={variantName} onChange={(e: any) => { setVariantName(e.target.value) }} />
                </div>
            </div>
            <div>
                <div className='font-semibold'>
            ...
            <div>
                ...
                <div>
                    <Input disabled={isDoing} placeholder='1500' type='number' className='h-10' value={price} onChange={(e: any) => { setPrice(e.target.value) }} />
                </div>
            </div>
            <div>
                <div className='font-semibold'>
