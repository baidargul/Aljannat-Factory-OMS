        ...
        <ScrollArea type='always' className='h-[400px] w-full border-y border-zinc-800 p-2'>
            <div className='grid grid-cols-6 gap-1 justify-items-center justify-between w-full'>
                ...
                <div>
                    {selectedProduct &&
                        <div className=''>
                            <DialogProvider title='Add new variation' description={`to ` + formalizeText(selectedProduct.product.name)} content={<CreateVariationForm selectedProduct={selectedProduct.product.id} setSelectedProduct={setSelectedProduct} />}>
                                {handleLastAddButton()}
                            </DialogProvider>
                        </div>
                    }
