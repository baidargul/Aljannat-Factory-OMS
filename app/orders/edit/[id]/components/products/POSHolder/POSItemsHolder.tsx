...
const POSItemsHolder = ({ products, selectedProduct, setSelectedProduct, POS }: Props) => {
            ...
            <div className='grid grid-cols-2 gap-1'>
              {selectedProduct.productVariations.map((variation: any) => (
                <div key={variation.id}>
                  <POSVariation POS={POS} selectedProduct={selectedProduct} variation={variation} setSelectedProduct={setSelectedProduct} />
                </div>
              ))}
            </div>
          </ScrollArea>
